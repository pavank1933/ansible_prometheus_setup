...
echo "$prometheus_server ansible_ssh_user=ec2-user ansible_ssh_private_key_file=/ec2-user/.ssh/id_rsa" >> ../hosts
...
echo "$prometheus_client ansible_ssh_user=ec2-user ansible_ssh_private_key_file=/ec2-user/.ssh/id_rsa" >> ../hosts
